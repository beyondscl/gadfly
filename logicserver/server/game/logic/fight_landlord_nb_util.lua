    ...
    if #cards >= 10 then
        ...
        if f then
            for i = 2 * p + 1, #cards do
                ...
                if f2 then
                    return true, max2, leng2 --只需要333***的张数即可
                end
            end
        end
...
function nbTool.check(originCards, targetCards, usedCards, curUid)
    ...
    if nbTool.checkLegal(realCards, targetCards) then --存在校验
        ...
        elseif flag == originCards[1] then --相同牌行检测
            ...
            if cardtype == nbTool.ZHADAN or cardtype == nbTool.WANGZHA then
    ...
    luadump("nbtoo check cards return false ---->")
    return false
end
...
--local originCards = {
--    [1] = 5, --牌行
--    [2] = { 111, 111, 212, 212, 313, 313 }, --普通牌
--    [3] = {}
--}
--local targetCards = { 111, 111, 212, 212, 313, 313, 414, 414, 521 }
--local usedCards = {-- [1] = {
--    --     [1] = 5, --牌行
--    --     [2] = { 101, 101, 102, 102, 103, 103 }, --普通牌
--    --     [3] = {},
--    --     [4] = 103, --最大值
--    --     [5] = 6, --长度
--    --     [6] = nil --uid
...
--}
----- - 测试一下
-- local r = nbTool.check(originCards, targetCards, usedCards)
-- print(r)
return nbTool