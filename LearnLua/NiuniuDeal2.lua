...
没牛0<有牛[1-9]<牛牛10<顺子11<葫芦21<五小牛31<五花牛41<炸弹51<同花顺61
]]
--[[
...
function cardTool.doGetNiu(cards)
    ...
    print(table.concat(cardCalculate,','))
    -- t = cardTool.sort(cardCalculate)
    -- return  t
end

--提供外部接口判断
function niuniuCompare(master,client)
    ...
    if m == c then 
        ...
        return cardTool.compare(masterMax,clientMax)
    else
...
-- --接口测试
-- client = {401,402,403,404,405}
-- master = {301,302,303,304,305}
client = {312,101,208,110,405}
master = {304,301,204,201,206}
-- print("接口测试",niuniuCompare(master,client))
-- cardTool.doGetNiu(master)
